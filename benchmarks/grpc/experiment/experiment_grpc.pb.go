...
type ExperimentClient interface {
	...
	Test2(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Test1Res, error)
	Test3(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Test1Res, error)
}
...
func (c *experimentClient) Test2(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Test1Res, error) {
	out := new(Test1Res)
...
func (c *experimentClient) Test3(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Test1Res, error) {
	out := new(Test1Res)
...
type ExperimentServer interface {
	...
	Test2(context.Context, *Empty) (*Test1Res, error)
	Test3(context.Context, *Empty) (*Test1Res, error)
...
func (UnimplementedExperimentServer) Test2(context.Context, *Empty) (*Test1Res, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Test2 not implemented")
}
func (UnimplementedExperimentServer) Test3(context.Context, *Empty) (*Test1Res, error) {
